run_name = 'p1d1w2f5s9to12r1_20170108_sdpol_comparison';
%{
# Run Simulation file
- Project 1:
...
- Subfigures 9-12:
    - Baseline-silent/depolarized and highdose-alpha cases for comparison. Using
    slightly depolarized state 0.3, higher gh 0.0032
- Run 1:
    - There should probably only be a single run! Using more depolarized state
    0.3, higher gh 0.0032
- Date Created:
    - 20170108
- Inherits from:
    - 'p1d1q41c4i6_20160919_cOFF_propomech_f5_sdpol.m'
%}
