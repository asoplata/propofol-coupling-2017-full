run_name = 'p1d1w2f2s2to3r1_20170106_simple_propo';
%{
# Run Simulation file
- Project 1:
...
- Figure 2:
    ...
    simulation
- Subfigures 2-3:
    - Voltage traces of TC #1 under baseline and highdose
- Run 1:
  - Illustrating baseline-silent depolarization, highdose-oscillating, using
    depolarized state 0.3, higher gh 0.0032
- Date Created:
    - 20170106
- Inherits from:
